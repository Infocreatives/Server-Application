...
Public Class Invoice
    ...
    Private Sub bgWorker_DoWork(sender As System.Object, e As System.ComponentModel.DoWorkEventArgs) Handles bgWorker.DoWork
        If Status = "S" Then
            Try
                con.Open()
                Dim da As New SqlDataAdapter("Select * from PUSInvoiceDetails where InvoiceID='" & Param(0) & "'", con)
                ds.Tables.Clear()
                da.Fill(ds, "Data")
                Result = "True"
        ...
        ElseIf Status = "A" Then
            ...
            Try
                ...
                Dim cmdCommand As SqlCommand = New SqlCommand("Delete from PUSInvoiceDetails where InvoiceID='" & Param(0) & "'", con, trn)
                cmdCommand.ExecuteNonQuery()
                Dim cmd As SqlCommand
                cmd = New SqlCommand("Insert into PUSInvoiceDetails(InvoiceID,InvoiceData) values ('" & Param(0) & "','" & str & "')", con, trn)
                cmd.ExecuteNonQuery()
                trn.Commit()
                Result = "True"
            Catch ex As Exception
        ...
        ElseIf Status = "L" Then
            Try
                con.Open()
                Dim da As New SqlDataAdapter("Select * from PUSItem where ItemType='1'", con)
                ds.Tables.Clear()
                da.Fill(ds, "Data")
                Result = "True"
            Catch ex As Exception
    ...
    Private Sub txtS1_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles txtS21.KeyPress, txtS20.KeyPress _
          ...
          , txtS3.KeyPress, txtS2.KeyPress, txtS22.KeyPress
    ...
    Private Sub txtP1_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles txtP21.KeyPress, txtP20.KeyPress _
        ...
        , txtP3.KeyPress, txtP2.KeyPress, txtAmount.KeyPress, txtP22.KeyPress
    ...
    Private Sub txtQ1_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles txtQ21.KeyPress, txtQ20.KeyPress _
        ...
        , txtQ3.KeyPress, txtQ2.KeyPress, txtQ22.KeyPress
        e.Handled = NumericKey(Asc(e.KeyChar))
    End Sub
    ...
    Private Sub Invoice_Resize(sender As Object, e As System.EventArgs) Handles Me.Resize
