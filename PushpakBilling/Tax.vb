...
Public Class Tax
    ...
    Private Sub Tax_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub bgWorker_DoWork(sender As System.Object, e As System.ComponentModel.DoWorkEventArgs) Handles bgWorker.DoWork
        If Status = "S" Then
            Try
                con.Open()
                Dim da As New SqlDataAdapter("Select * from PUSTaxDetails where TaxID='" & Param(0) & "'", con)
                ds.Tables.Clear()
                da.Fill(ds, "Data")
                Result = "True"
        ...
        ElseIf Status = "A" Then
            ...
            Try
                ...
                Dim cmdCommand As SqlCommand = New SqlCommand("Delete from PUSTaxDetails where TaxID='" & Param(0) & "'", con, trn)
                cmdCommand.ExecuteNonQuery()
                Dim cmd As SqlCommand
                cmd = New SqlCommand("Insert into PUSTaxDetails(TaxID,TaxData) values ('" & Param(0) & "','" & str & "')", con, trn)
                cmd.ExecuteNonQuery()
                trn.Commit()
                Result = "True"
            Catch ex As Exception
        ...
        ElseIf Status = "L" Then
            Try
                con.Open()
                Dim da As New SqlDataAdapter("Select * from PUSItem where ItemType='3'", con)
                ds.Tables.Clear()
                da.Fill(ds, "Data")
                Result = "True"
            Catch ex As Exception
    ...
    Private Sub Tax_Resize(sender As Object, e As System.EventArgs) Handles Me.Resize
